    ...
    <div class="row">
      <div class="col-12 col-lg-9">
        <div class="card">
          ...
          >
            <div
              class="mb-5 d-md-flex d-block justify-content-between"
            ...
            >
              <div class="d-flex">
                ...
                <div class="ms-5">
                  ...
                  <p class="seim-dark">
                    {{ cart.author }} |
                    <span class="small"> {{ cart.category }} </span>
                  </p>
              ...
              >
                <div class="d-flex align-items-center">
                  <button
                    class="btn btn-outline-secondary btn-sm btn-minus me-1"
                    @click="reduceQty(cart)"
                  >
                    <i class="fas fa-minus"></i>
                  </button>
                  <input
                    type="number"
                    class="form-control cart-form w-25 text-center quantity"
                    :value="cart.qty"
                    min="1"
                  />
                  <button
                    class="btn btn-outline-secondary btn-plus btn-sm ms-1"
                    @click="addQty(cart)"
                  >
                ...
                <div class="ms-5 d-flex">
                  <p class="fs-5 text-nowrap">
                    {{ (cart.sub = cart.price * cart.qty) }} Ks
                  </p>
                  <button
                    class="btn btn-danger btn-sm ms-4 ms-md-5"
                    @click="delCart(cart, index)"
                  >
